...
const OCR = {
  ...
  parseMultiple(rawText) {
    ...
    // Estratégia 1: formato "lista" do ReVive — onde tem labels tipo "Processo:", "Fechamento:", "Cidade:", "Consultor:"
    // Cada bloco começa com uma linha de NOME e termina antes do próximo bloco que começa com nome
    const hasListFormat = /processo\s*:/i.test(text) && /consultor\s*:/i.test(text);
    ...
    // Senão, parser padrão (1 cliente só) — formato card detalhado
